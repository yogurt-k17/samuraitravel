...
/* faqsテーブル */
INSERT IGNORE INTO faqs (id, question, answer) VALUES (1, '人気の民宿はどこで確認できますか？', 'トップページにアクセスすると、予約数の多い人気の民宿が一覧表示されます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (2, '新しく登録された民宿はどこで確認できますか？', 'トップページの「新着民宿」セクションに最新の民宿が表示されます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (3, '民宿を地域で絞り込んで探すことはできますか？', '47都道府県からエリアを選択することで、該当地域の民宿を検索できます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (4, 'キーワードで民宿を検索するにはどうすればよいですか？', 'トップページまたは民宿一覧ページの検索バーにキーワードを入力してください。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (5, '宿泊料金で民宿を絞り込むことはできますか？', '民宿一覧ページで1泊あたりの予算を指定して検索できます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (6, '並び替え機能にはどのような項目がありますか？', '新着順または宿泊料金が安い順で並び替えが可能です。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (7, '民宿の詳細はどこで確認できますか？', '民宿一覧ページで対象の民宿をクリックすると、詳細ページに遷移します。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (8, '会員登録しないと予約はできませんか？', 'はい、予約には会員登録およびログインが必要です。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (9, '会員登録に必要な情報を教えてください。', '氏名、フリガナ、郵便番号、住所、電話番号、メールアドレス、パスワードが必要です。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (10, '会員登録の際にメール認証は必要ですか？', 'はい、登録確認のためにメール認証を行っていただきます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (11, 'ログインできないときはどうすればよいですか？', 'メールアドレスまたはパスワードに誤りがないかご確認ください。それでも解決しない場合は、お問い合わせフォームからご連絡ください。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (12, '予約の際に入力する情報を教えてください。', 'チェックイン日、チェックアウト日、宿泊人数をご入力いただきます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (13, '予約内容は確認できますか？', 'はい、予約ボタン押下後に予約内容確認ページで詳細を確認できます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (14, '支払いはどのように行いますか？', 'Stripeによるオンライン決済が可能です。クレジットカード情報をご入力ください。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (15, '支払後、予約履歴はどこで見られますか？', 'ログイン後、「予約一覧ページ」から過去の予約履歴をご覧いただけます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (16, '予約一覧が多すぎて見にくいのですが？', '予約一覧は10件ずつページネーションで表示されますので、ページを切り替えてご覧ください。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (17, '登録した会員情報は確認できますか？', 'ログイン後、「会員詳細ページ」で確認可能です。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (18, '住所や電話番号を変更したい場合はどうすればいいですか？', '「会員詳細ページ」から「編集リンク」をクリックすると編集ページへ遷移できます。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (19, 'パスワードを変更する機能はありますか？', '現時点では対応していませんが、今後のアップデートで追加予定です。');
INSERT IGNORE INTO faqs (id, question, answer) VALUES (20, 'ログアウトするにはどうすればいいですか？', '画面右上のメニューから「ログアウト」を選択してください。');
